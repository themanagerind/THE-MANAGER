    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-paper">
      ...
      <aside className="hidden md:flex md:w-64 md:flex-col bg-navy text-white">
        <div className="px-6 py-5 border-b border-white/10 flex items-center gap-3">
          <img src="/logo.png" alt="" className="w-9 h-9 rounded-full bg-white/5 object-cover" />
          <span className="text-lg font-semibold tracking-tight">Society Manager</span>
        </div>
      ...
      <header className="md:hidden sticky top-0 z-10 flex items-center justify-between bg-navy text-white px-4 py-3">
        <div className="flex items-center gap-2">
          <img src="/logo.png" alt="" className="w-7 h-7 rounded-full bg-white/5 object-cover" />
          <span className="font-semibold">Society Manager</span>
        </div>
        <div className="flex items-center gap-2">
