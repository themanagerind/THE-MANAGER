...
import { 
  ...
  ClipboardList, Bell, MessageSquare, BarChart3, LogOut, Menu, X, ChevronDown
} from 'lucide-react';
...
const AdminLayout = ({ children }) => {
  ...
  const navItems = [
    ...
    { path: '/admin/flats', icon: Home, label: 'Flat Mapping' },
    { path: '/admin/residents', icon: Users, label: 'Residents' },
    { path: '/admin/maintenance', icon: Receipt, label: 'Maintenance Bills' },
